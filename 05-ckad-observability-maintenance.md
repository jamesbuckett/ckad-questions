...
- Use provided tools to monitor Kubernetes applications [\*\*](#05-01-cpu-and-memory-of-pods-question)
- Utilize container logs [\*\*](#05-02-pod-logging-question)
- Debugging in Kubernetes [\*\*](#05-04-jsonpath-question)
<br />
